...
function postToPinboard(a,c){var d={url:c.url,description:c.title};localStorage.getItem(keyName)?post(d,JSON.parse(localStorage.getItem(keyName))):(localStorage.setItem(queueName,JSON.stringify(d)),chrome.tabs.create({url:"settings.html"}))}function toggleStatus(){var a=document.getElementById("status");a.style.visibility="visible"===a.style.visibility?"hidden":"visible"}
